...
// const positionsAttribute = new THREE.BufferAttribute(positionsArray,3) // 3 is (x,y,z)
...
/* #region Many triangle*/

// create random points between -2 to 2 scale
const triCount = 50;
const scale = 2;
const positionsArray = new Float32Array(triCount * 3 * 3);
for (let index = 0; index < positionsArray.length; index++) {
  positionsArray[index] = (Math.random() - 0.5) * scale;
}
