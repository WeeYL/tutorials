...
// PHYSIC shape and body
const sphereShape = new CANNON.Sphere(0.5); // radius same as mesh sphere
...
const tick = () => {
  ...
  prevTime = elapsedTime; // update
  world.step(1 / 60, deltaTime, 3);

  // PHYSIC world force eg, wind
  sphereBody.applyForce(new CANNON.Vec3(-0.5,0,0), 
  sphereBody.position)

  // PHYSIC update THREE object
